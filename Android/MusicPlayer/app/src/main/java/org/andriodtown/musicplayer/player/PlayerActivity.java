...
import org.andriodtown.musicplayer.Constant;
import org.andriodtown.musicplayer.PlayerPagerAdapter;
import org.andriodtown.musicplayer.R;
...
public class PlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void load(){
        ...
        if(intent!=null){
            current = intent.getIntExtra(Constant.KEY_POSITION, -1 );
        }
